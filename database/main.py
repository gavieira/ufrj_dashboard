...
if __name__ == "__main__":
    ...
    db_url = "postgresql+psycopg2://gid_admin:dashboard@postgres:5432/gid_admin" #db_url (needed for the creation of the db_handler object - optional if data is being saved to jsonl file)

    #Creating db_handler object (also needed for retrieval of OpenAlex data)
    db_handler = OpenAlexDatabaseHandler(db_url) #Initialize db_handler object
    db_handler.create_all_tables() #Creates tables in database
